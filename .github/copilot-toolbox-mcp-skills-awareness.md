...
_Generated: 2026-06-21T07:48:51.842Z_
...
Workspace `mcp.json` _(folder: Url Shortner)_

- **c:\Users\mittu\Url Shortner\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\mittu\AppData\Roaming\Code\User\mcp.json** — _File missing_
